export const columnData = {
  task: {
    "task-1": {
      ...
      desc: "Start implementing new design in coding @Headlinema",
      meta: {
        users: [{ value: "Sara Dervashi", label: "Sara Dervashi", theme: "light" }],
        tags: [
          { value: "Headlinema", label: "Headlinema", theme: "info" },
    ...
    "task-2": {
      id: "task-2",
      title: "Headlinema Version",
      desc: "Implement new UI design in react version @Headlinema Pro as soon as possible.",
      meta: {
    ...
    "task-3": {
      id: "task-3",
      title: "Headlinema Design Kit Update",
      desc: "Update the new UI design for @Headlinema Pro with based on feedback.",
      board: "In Progress",
      meta: {
