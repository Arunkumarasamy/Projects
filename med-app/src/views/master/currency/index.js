...
import { List_currency } from "./component/list_currency";
import Add_currency from "./component/add_currency";
import Edit_currency from "./component/edit_currency";
...
export default function Currency() {
  ...
  // data list
  const currency_Data_List = async () => {
    ...
    try {
      ...
      const response = await fetch(Url.api + Url.currencyList, {
        method: "POST",
        headers: {
      ...
      if (responseData.apiStatus.code == "200") {
        setCurrencyList(responseData.result.CurrencyData);
  ...
  useEffect(() => {
    const { columns: newColumns, rows: newRows } = List_currency(
      currencyList,
      openEdit,
      openDel
    );
  ...
  const deleteCurrency = async () => {
    ...
    const response = await fetch(
      Url.api + Url.currencyDelete + selectedValue.id,
      {
        method: "DELETE",
        headers: {
          "content-type": "application/json",
        ...
        <Paper elevation={3} sx={{ mb: 5 }}>
          ...
          <Dialog open={openDeleteDialog} onClose={closeDialog}>
            ...
            <DialogContent sx={{ mt: -2, textAlign: "center" }}>
              ...
              <DialogContentText>
                <b>"{selectedValue?.currency_code}"?</b>
              </DialogContentText>
            </DialogContent>
            <DialogActions
